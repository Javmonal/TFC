 ...
 * @author javier
 */
public class AnyadirCliente extends javax.swing.JFrame {
    ...
    public AnyadirCliente() {
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/TFG/Imagenes/1490793813-user-interface20_82328.png")));

// Ajustar el tamaño de la imagen al JLabel de manera proporcional
ImageIcon icon = (ImageIcon) jLabel5.getIcon();
Image image = icon.getImage();
Image newImage = image.getScaledInstance(jLabel5.getWidth(), jLabel5.getHeight(), Image.SCALE_SMOOTH);
jLabel5.setIcon(new ImageIcon(newImage));
    ...
    private void initComponents() {
        ...
        btnAnyadir.setText("Añadir cliente");
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(53, 53, 53)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jTextTelefono, javax.swing.GroupLayout.PREFERRED_SIZE, 191, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jTextDireccion, javax.swing.GroupLayout.PREFERRED_SIZE, 191, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnAnyadirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAnyadirActionPerformed
        ...
        metodos.anyadirCliente(nombre,direccion,telefono);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AnyadirCliente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AnyadirCliente().setVisible(true);
            }
        });
    }
